...
public class SignupForm {
    ...
    public static GridPane createSignUpForm(Controller controller, GUIManager guiManager){
        ...
        signupForm.add(bioTextField,1,10);
        ...
        signupForm.setMargin(bioTextField      ,new Insets(0,0,15,0));
        ...
        signupForm.setMargin(bioLabel      ,new Insets(0,0,15,0));
        ...
        signupForm.add(submitNewUser    ,0,11);
