...
public abstract class DataManager {
     ...
     * ModelData.DatabaseManagers.UserDataManager takes a user object and adds that to the users database
    ...
    /**
     * This method will only be called by child class of ModelData.DataManager. The initialization will set the table to the class that it was initialized by.
